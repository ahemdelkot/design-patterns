...
public class OnePlayer extends JFrame {
    public OnePlayer() {
        OnePlayerEventListener listener = new OnePlayerEventListener();
...
class OnePlayerEventListener implements GLEventListener, MouseMotionListener, MouseListener {
    /*
     * // ? number from 0 to 9
...
//         ! the y-axis
    ...
    public void mousePressed(MouseEvent e) {
        ...
        if (mouseX > 0 && mouseX < 40 && mouseY > -50 && mouseY < 100) {
    ...
    private void button(int x, int y) {
        ...
        if (mouseX > x - 130 && mouseX < x + 130 && mouseY > y - 50 && mouseY < y + 50) {
//            System.out.println("on target");
        ...
        gl.glEnable(GL.GL_TEXTURE_2D); // إعادة التكسشر
    }

...
public class BitmapLoader {
    public static BufferedImage loadBitmap(String file) throws IOException {
        ...
        try {
            ...
            // int nSize = bytesToInt(bitmapFileHeader, 2);  // ! commented by Mo
            int nWidth = bytesToInt(bitmapInfoHeader, 4);
            int nHeight = bytesToInt(bitmapInfoHeader, 8);
            // int nBiSize = bytesToInt(bitmapInfoHeader, 0);  // ! commented by Mo
            // int nPlanes = bytesToShort(bitmapInfoHeader, 12);  // ! commented by Mo
            int nBitCount = bytesToShort(bitmapInfoHeader, 14);
            int nSizeImage = bytesToInt(bitmapInfoHeader, 20);
            // int nCompression = bytesToInt(bitmapInfoHeader, 16);  // ! commented by Mo
            int nColoursUsed = bytesToInt(bitmapInfoHeader, 32);
            // int nXPixelsMeter = bytesToInt(bitmapInfoHeader, 24);  // ! commented by Mo
            // int nYPixelsMeter = bytesToInt(bitmapInfoHeader, 28);  // ! commented by Mo
            // int nImportantColours = bytesToInt(bitmapInfoHeader, 36);  // ! commented by Mo
